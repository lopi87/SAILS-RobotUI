...
AÑADIR COSAS DESTACADAS A MODO RESUMEN Y CONCLUSIONES
...
\item Elaborar un generador de código para la exportación en los dispositivos robótivos, reduciendo por tanto las labores de programación.
