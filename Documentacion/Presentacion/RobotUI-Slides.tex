...
\frame{\frametitle{\textcolor{black}{ Interfaz - Modalidades }}
  \begin{figure}[H]
      \centering
...
\frame{\frametitle{\textcolor{black}{ Robot de pruebas }}
\begin{figure}[H]
\includegraphics[width=8.5cm]{robot2.jpg}
\end{figure}
}
...
\frame{\frametitle{\textcolor{black}{Preguntas}}
...
\begin{figure}[H]
\includegraphics[width=4.5cm]{preguntas.jpg}
\end{figure}
