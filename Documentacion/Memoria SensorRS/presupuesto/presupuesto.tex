...
\begin{table}[H]
  \begin{center}
    \begin{tabular}{|p{8cm}|p{2cm}|p{2cm}|p{2cm}|}
      ...
      \hline
      \vspace{+0.2in}{Batería Lipo 11.1v 2200mAh } & \vspace{+0.2in}{1} & \vspace{+0.2in}{13,99} & \vspace{+0.2in}{13,99}\\
      \hline
...
\begin{table}[H]
  \begin{flushright}
    \begin{tabular}{p{6cm}p{6cm}}
      ...
      \vspace{+0.2in}\textbf{Total presupuesto:} & \vspace{+0.2in}{\EUR{21496,08}}\\
    \end{tabular}
  \end{flushright}
\end{table}
