...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{imagenes/robot/frontal.jpg}
        \caption{Vista frontal-superior}
        \label{fig:gull}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=1.19\textwidth]{imagenes/robot/lateral.jpg}
        \caption{Vista lateral}
        \label{fig:tiger}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=\textwidth]{imagenes/robot/trasera.jpg}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[scale=0.3]{imagenes/robot/general.png}
  \end{center}
