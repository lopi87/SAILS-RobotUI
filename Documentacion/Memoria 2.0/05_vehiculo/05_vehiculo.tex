...
Los pines \texbf{IN1}, \texbf{IN2}, \texbf{IN3} y \texbf{IN4}; son los pines de entrada donde se conectan a pines digitales de Arduino para poder controlar el motor.
...
Para el caso del proyecto, hemos empleado las salidas para dos motores que el driver proporciona, una de ellas para traccionar el vehículo y la segunda para accionar la dirección.

Se ha optado finalmente por un motor DC para la dirección debido que el chasis empleado para la constucción del robot ya lo traía así incorporado y se ha decicido reutilizar. De 
igual modo se podría haber usado un servomotor para el accionamiento de la dirección, pero debido a una mayor simplicidad en el montaje y puesto que el motor ya incorporado 
dispone de una mejor sujeción al chasis sin necesidad de hacer adaptaciones así se ha decidido.

\subsection{Motores}

A continuación se muestra le motor de dirección empleado con el sistema de topes de recorrido que incorpora.
...
Motor de tracción del vehículo situado en su parte trasera.
...
Con el fin de dotar de iluminación al vehículo, se ha incorporado una serie de leds en los faros del vehículo tanto en su parte delantera como trasera. Dichos leds van concetados a un
pin del Arduino con la finalidad de poder encenderlos o apagarlos al deseo del operador. 
...
\subsection{Sensor de lluvia}


\subsubsection{Conexionado}


\subsection{Sensor de impacto}
