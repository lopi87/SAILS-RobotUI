...
un menor consumo del ancho de banda, ver Figura \ref{fig:consumo_http_websocket}.\\
  
\begin{figure}[H]
  \begin{center}
    \includegraphics[scale=0.4]{imagenes/http_websocket_consumo.png}
  \end{center}
  \label{fig:consumo_http_websocket}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=1.19\textwidth]{imagenes/websocket_fases.png}
...
emplea un sistema de formato de mensajes para la comunicación entre Arduino y Raspberry Pi muy similar al empleado en el presente proyecto..\\
...
\hspace*{2.25in}{\includegraphics[scale=0.5]{imagenes/fritzing-logo.png}}
...
\hspace*{2.25in}{\includegraphics[scale=0.5]{imagenes/arduino-logo.png}}
