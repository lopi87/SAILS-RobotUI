...
function change_img_busy(id, boolean, free_text, busy_text){
  ...
  if (boolean == 'true'){
      $(label_id).replaceWith("<span id=\"label_satate_" + id + "\" class=\"label label-pill label-danger \">" + busy_text + "</span>");
  }else{
      $(label_id).replaceWith("<span id=\"label_satate_" + id + "\" class=\"label label-pill label-success \">" + free_text + "</span>");
  }
}
