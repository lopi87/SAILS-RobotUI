...
function change_img_busy(id, boolean, free_text, busy_text){
  ...
  if (boolean){
      $(label_id).html("<span id=\"" + label_id + "\" class=\"label label-pill label-danger \">" + busy_text + "</span>");
  }else{
      $(label_id).html("<span id=\"" + label_id + "\" class=\"label label-pill label-success \">" + free_text + "</span>");
  }
}
